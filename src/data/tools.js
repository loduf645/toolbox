...
const TOOLS = [
  ...
  { id:'tts', name:'Text-to-Speech', cat:'text', desc:'Bacakan teks dengan suara bawaan browser — pilih voice, bahasa, kecepatan, nada, dan volume.', render:renderTTS, mount:mountTTS },
  { id:'case', name:'Case Converter', cat:'text', desc:'Ubah kapitalisasi teks: UPPERCASE, lowercase, Title Case, camelCase, snake_case, dan lainnya.', render:renderCase, mount:mountCase },
  { id:'cleaner', name:'Text Cleaner', cat:'text', desc:'Rapikan teks berantakan: hapus spasi berlebih, baris kosong, duplikat, urutkan baris, dan lainnya.', render:renderCleaner, mount:mountCleaner }
];
